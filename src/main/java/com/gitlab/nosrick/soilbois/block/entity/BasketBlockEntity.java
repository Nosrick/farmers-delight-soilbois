package com.gitlab.nosrick.soilbois.block.entity;

import com.gitlab.nosrick.soilbois.SoilBoisMod;
import com.gitlab.nosrick.soilbois.block.BasketBlock;
import com.gitlab.nosrick.soilbois.registry.BlockEntityTypeRegistry;
...
public class BasketBlockEntity extends LootableContainerBlockEntity implements Hopper {
    ...
    public BasketBlockEntity(BlockPos blockPos, BlockState blockState) {
        this(BlockEntityTypeRegistry.BASKET.get(), blockPos, blockState);
    }
    ...
    protected Text getContainerName() {
        return SoilBoisMod.i18n("container.basket");
    }
