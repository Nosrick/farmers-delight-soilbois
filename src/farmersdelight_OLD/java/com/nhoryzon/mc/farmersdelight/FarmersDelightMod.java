    ...
    protected void registerBiomeModifications() {
        BiomeModifications.addFeature(context ->
                ...
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_BEETROOTS.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_BEETROOTS.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_BEETROOTS.getPlacementModifiers())
                        .getKey().get());
        ...
        BiomeModifications.addFeature(context ->
                ...
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_CABBAGES.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_CABBAGES.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_CABBAGES.getPlacementModifiers())
                        .getKey().get());

        BiomeModifications.addFeature(context ->
                        context.getBiome().getDownfall() > 0.7f && context.getBiome().getTemperature() > 0.7f,
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_RICE.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_RICE.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_RICE.getPlacementModifiers())
                        .getKey().get());

        BiomeModifications.addFeature(context ->
                        context.getBiome().getTemperature() >= 1.f,
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_TOMATOES.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_TOMATOES.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_TOMATOES.getPlacementModifiers())
                        .getKey().get());

        BiomeModifications.addFeature(context ->
                        context.getBiome().getTemperature() > .3f && context.getBiome().getTemperature() < 1.f,
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_CARROTS.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_CARROTS.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_CARROTS.getPlacementModifiers())
                        .getKey().get());
        ...
        BiomeModifications.addFeature(context ->
                ...
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_ONIONS.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_ONIONS.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_ONIONS.getPlacementModifiers())
                        .getKey().get());

        BiomeModifications.addFeature(context ->
                        context.getBiome().getTemperature() > .0f && context.getBiome().getTemperature() < .3f,
                GenerationStep.Feature.VEGETAL_DECORATION,
                PlacedFeatures.register(
                                ConfiguredFeaturesRegistry.PATCH_WILD_POTATOES.getFeatureId(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_POTATOES.getRegistryEntry(),
                                ConfiguredFeaturesRegistry.PATCH_WILD_POTATOES.getPlacementModifiers())
                        .getKey().get());
    }
